  ...
  return (
    <div className="w-screen overflow-x-hidden mx-auto min-h-screen bg-black flex flex-col pt-10">
      <div className="w-full md:w-[85%] flex-1 mx-auto object-cover relative">
        <div className="px-5 absolute z-20 h-full flex flex-col md:flex-row gap-5 justify-between items-center">
          <div className="flex-[60%] w-full h-full flex flex-col p-5 capitalize justify-center items-center md:items-start gap-8">
          ...
          <div className="flex-[40%] w-full h-full"></div>
        </div>
