...
const Section3 = () => {
  return (
    <div className="w-full text-[#FFAD00] max-w-7xl mx-auto md:min-h-screen flex flex-col items-center gap-8 py-10 md:py-16 px-4">
      <div className="flex flex-col md:flex-row gap-10 md:gap-20 justify-between">
        <div className="flex-[40%] flex flex-col gap-8 justify-start">
          ...
          <p className="text-white lg px-4 md:px-0 text-center md:text-start">
        ...
        <div className="flex-[50%] hidden md:block">
          <h3 className="text-5xl leading-[1.5] font-bold text-[#FFAD00] w-full text-end uppercase">
